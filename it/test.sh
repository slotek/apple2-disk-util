...
GLI_DEBUG=true RUBYLIB=../lib ../bin/a2 cp STARMAZE src.dsk dest.dsk > out.txt
diff bsave.dsk dest.dsk > diff.txt

cp dest.dsk dest2.dsk
GLI_DEBUG=true RUBYLIB=../lib ../bin/a2 cp -d STARMAZE2 STARMAZE src.dsk dest2.dsk > out2.txt
